function btnSelectPoint(d,f){$("#inpostModalMap").modal("hide");setTimeout(function(){$("#inpostModalMap").after('<div class="radio"><label><input type="radio" name="shipping_method" value="inpost.inpost_'+d+'" checked="checked">'+d+" - "+f+"</label></div>");$.ajax({url:"/index.php?route=extension/shipping/inpost/setData",type:"POST",data:{id:d},error:function(a){a.responseText&&console.error(a.responseText)},success:function(a){console.log(a)}})},1E3)}
...
g=b.getAttribute("data-lat"),e=b.getAttribute("data-lng"),b=b.getAttribute("data-zoom");a(g,e,b);console.error("Geolocation is not supported by this browser.")}}function f(b,a){var e=$.Deferred();console.log(b,a);$.getJSON("/index.php?route=extension/shipping/inpost/index",{postcode:b,id:a}).done(function(b){e.resolve({data:b.data})});return e}function a(b,a,e){document.getElementById("inpost-google-map").getAttribute("data-content");b={scrollwheel:!1,navigationControl:!0,mapTypeControl:!1,scaleControl:!0,
