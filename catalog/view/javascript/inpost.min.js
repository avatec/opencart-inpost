function btnSelectPoint(d,f){$("#inpostModalMap").modal("hide");setTimeout(function(){$("#inpostModalMap").after('<div class="radio"><label><input type="radio" name="shipping_method" value="inpost.inpost_'+d+'" checked="checked">'+d+" - "+f+"</label></div>");$.ajax({url:"/index.php?route=api/inpost/setData",type:"POST",data:{id:d},error:function(a){a.responseText&&console.error(a.responseText)},success:function(a){console.log(a)}})},1E3)}
